...
const kitchenMethodsRouter = require("./routes/kitchenMethods.js");
const allergensRouter = require("./routes/allergens.js");
const dishCategoriesRouter = require("./routes/dishCategories.js");
const upsellsRouter = require("./routes/upsells.js");
...
app.use("/api/kitchen-methods", authenticate, kitchenMethodsRouter);
app.use("/api/allergens", authenticate, allergensRouter);
app.use("/api/dish-categories", authenticate, dishCategoriesRouter);
app.use("/api/upsells", authenticate, upsellsRouter);
